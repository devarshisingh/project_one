                                ...
                                foreach ($query_run as $row) {
                                    ?>
                                                        <tr>
                                                            ...
                                                            <th ><?php echo htmlspecialchars($row['cats_name']); ?></th>
                                                ...
                                                <td>
                                                          <a href="edits_product_details.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                                <form action="codes.php" method="POST" class="d-inline">
                                                    <input type="hidden" name="delete" value="<?php echo $row['id']; ?>">
                                                    <button type="submit" name="delete_btn_p" class="btn btn-danger btn-sm">Delete</button>
                                                </form>
                                                          </td>    
