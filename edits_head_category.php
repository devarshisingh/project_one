...
<div id="pcoded" class="pcoded">
    ...
    <div class="pcoded-container navbar-wrapper">
        ...
        if (isset($_GET['id'])) {
            $id = $_GET['id'];
            $register_query = "SELECT * FROM category_head WHERE id='$id'";
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    <h4 class="sub-title">Edit Category Head Details</h4>
                                                    ...
                                                    <form action="codes.php" method="POST"
                                                        ...
                                                        <label class="col-sm-2 col-form-label">Category Name</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" name="c_h_name" value="<?php echo htmlspecialchars($row['c_h_name']); ?>"
                                                                    placeholder="Type your Category New Name">
                                                            </div>
                                                        </div>
                                                        <button type="submit" class="btn btn-info" data-container="body"
                                                            name="updates" data-toggle="popover"
