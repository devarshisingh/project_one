                                ...
                                foreach ($query_run as $row) {
                                    ?>
                                                ...
                                                style="width: 100px; height: 100px;"></td>
                                                          ...
                                                          <td>
                                                          <a href="edits_head_category.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                                <form action="codes.php" method="POST" class="d-inline">
                                                    <input type="hidden" name="delete" value="<?php echo $row['id']; ?>">
                                                    <button type="submit" name="delete_btnss" class="btn btn-danger btn-sm">Delete</button>
                                                </form>
                                                          </td>  
                                                        </tr>
                                                        <?php
